...
if menu == "Dashboard":
    ...
    st.markdown("<div style='font-size:25px; font-weight:600; margin-bottom:10px; margin-top:10px;'>Aktivitas Terbaru</div>", unsafe_allow_html=True)
    if s["total"] > 0:
        df_rt = pd.DataFrame({
        ...
        st.info("Belum ada data grafik maupun daftar pengujian pada sesi ini.")
    ...
    if st.session_state.dataset is not None:
        ...
        if 'Label Asli' in df_batch.columns:
            ...
            # PERBAIKAN 1: Urutan kategori disamakan dengan standar akademis
            ...
            # PERBAIKAN 2: Menambahkan yaxis=dict(autorange="reversed") agar dibaca dari atas ke bawah
